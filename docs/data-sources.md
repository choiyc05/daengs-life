...
|---|---|---|---|---|
| 공통 · 법령 | 4 | **1** | 3 | 국가법령정보 Open API (조문 단위) |
...
- [ ] **`law-animal-protection`** — 동물보호법 / 시행령 / 시행규칙 웹 원문 · `html` · 키없음 · ✅확인
- [ ] **`law-livestock-epidemic`** — 가축전염병예방법 (광견병 근거) · `html` · 키없음 · ⚠️요확인

### 수집 대상 법령 (API 확보 후 조문 단위 재수집)

- [ ] **동물보호법 / 시행령 / 시행규칙** — 등록 의무, 안전조치(목줄 2m), 맹견 5종(시행규칙), 맹견사육허가제(2024.4.27 시행), 맹견 책임보험, 과태료 → 등록·맹견 도메인
- [ ] **가축전염병 예방법** — 광견병(제2종 가축전염병) 예방접종 명령 → 접종 도메인
- [ ] **수의사법** — 진료·처방 → 접종·의료
...
- [ ] `law-livestock-epidemic` — 가축전염병예방법 웹 원문 URL
...
- [ ] `gov24-registration`
- [ ] `nias-pet`
- [ ] `law-animal-protection`
- [ ] `mafra-press`
- [ ] `korea-kr-policy`
- [ ] `seoul-microchip-support`
- [ ] `law-livestock-epidemic` (⚠️ URL 확인 후)
